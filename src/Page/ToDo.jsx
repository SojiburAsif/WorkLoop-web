...
const ToDo = () => {
    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:3000/bookings?providerEmail=${encodeURIComponent(user.email)}`)
            .then(res => res.json())
            .then(data => {
                const filtered = data.filter(b => b.userEmail !== user.email);
                        ...
                        >
                            <div className="p-4">
                                ...
                                <div className="mt-4">
                                    ...
                                    <p className="text-sm text-red-500">{b.providerName}</p>
